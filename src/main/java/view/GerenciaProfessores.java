...
public class GerenciaProfessores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        javax.swing.JButton export = ViewUtils.criarBotao(Constantes.UIConstants.BTN_EXPORTAR, this::menuExportActionPerformed);
        javax.swing.JMenuBar jMenuBar1 = ViewUtils.criarMenuBar();
        javax.swing.JMenu menu = ViewUtils.criarMenu("Menu", "menu");
        javax.swing.JMenuItem menuGerenciaAluno = ViewUtils.criarMenuItem(
            "Gerenciar Alunos",
            this::menuGerenciaAlunosActionPerformed,
            "menuGerenciaAluno"
        );
