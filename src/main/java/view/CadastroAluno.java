 ...
 * <p>
 * Esta classe representa a interface gráfica utilizada para cadastrar novos
 * alunos no sistema. Ela realiza validações, coleta dados do usuário e delega
 * a operação de inserção ao {@link AlunoDAO}.
 * </p>
 */
public class CadastroAluno extends javax.swing.JFrame {

    /**
     * DAO responsável pelas operações de persistência de {@link Aluno}.
     * Declarado como transient para evitar problemas de serialização.
     */
     ...
     * <p>
     * Inicializa os componentes gráficos, configura botões padrão e instancia o DAO.
     * </p>
     */
    ...
    /**
     * Método gerado automaticamente pelo Form Editor (Swing).
     * <p>
     * Responsável por inicializar e organizar todos os componentes gráficos da
     * tela. Não deve ser modificado manualmente.
     * </p>
     */
    ...
    private void initComponents() {
        ...
        ViewUtils.configurarTelaCadastroPadrao(this, lblTitulo, "Cadastro de Aluno", bCancelar, bConfirmar);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup().addGroup(layout
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                        layout.createSequentialGroup().addContainerGap().addComponent(lblNome,
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(fase, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(lblNascimento).addComponent(lblFase))
                        .addComponent(idade, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 35, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(bConfirmar, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
                        .addComponent(bCancelar, javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    /**
     * Ação executada quando o usuário clica no botão Confirmar.
     * <p>
     * Este método realiza:
     * <ul>
     * <li>Validação dos dados de entrada</li>
     * <li>Construção do objeto {@link Aluno}</li>
     * <li>Inserção via {@link AlunoDAO}</li>
     * <li>Exibição de mensagens de sucesso ou erro</li>
     * </ul>
     * </p>
     *
    ...
    /**
     * Ação executada quando o usuário clica no botão Cancelar.
     * <p>
     * Fecha a janela atual de forma segura utilizando o {@link ViewUtils}.
     * </p>
     *
