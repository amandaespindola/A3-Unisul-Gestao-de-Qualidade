 ...
 *
 * <p>
 * A classe não pode ser instanciada.</p>
 */
public class ViewUtils {
    ...
    /**
     * Cria o painel de botões padrão de gerenciamento: Atualizar, Cadastrar,
     * Editar, Deletar e Exportar.
     *
    ...
    /**
     * Cria um menu padrão de gerenciamento contendo: - item principal - Sobre -
     * Sair
     *
    ...
    /**
     * Adiciona botões de confirmar e cancelar em um painel. Define também o
     * botão confirmar como default da janela.
     *
    ...
    /**
     * Aplica formatação aos campos de CPF, contato e salário, exibindo alerta
     * caso ocorra erro.
     *
    ...
    /**
     * Cria o painel superior completo da tela de gerenciamento, contendo título
     * e botões.
     *
    ...
    /**
     * Cria os cinco botões padrão de gerenciamento, aplicando ícones quando
     * disponíveis.
     *
