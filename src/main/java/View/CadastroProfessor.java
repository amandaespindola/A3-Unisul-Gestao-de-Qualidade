...
public class CadastroProfessor extends javax.swing.JFrame {
    ...
    private String validarCpf() throws Mensagens {
        String cpfFormatado = ValidadorInput.validarTamanhoNumericoFixo(
                this.cpfFormatado.getText(),
                11,
                "CPF"
        );
    ...
    private void bConfirmarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bConfirmarActionPerformed
        ...
        try {
            ...
            String campusProfessor = ValidadorInput.validarSelecaoComboBox(
                    this.campus.getSelectedIndex(),
                    Constantes.CAMPUS,
                    "Campus"
            );
            String cpfProfessor = validarCpf();
            String contatoProfessor = ValidadorInput.validarTamanhoNumericoFixo(
                    this.contatoFormatado.getText(),
                    11,
                    "Contato"
            );
            ...
            String tituloProfessor = ValidadorInput.validarSelecaoComboBox(
                    this.titulo.getSelectedIndex(),
                    Constantes.TITULOS,
                    "Título"
            );
