...
public class EditarProfessor extends javax.swing.JFrame {
	...
	private static final String[] ARRAY_TITULO = { "-", "Graduação", "Especialização", "Mestrado", "Doutorado" };
	...
	private void preencheCampos() {
		...
		for (int i = 0; i < ARRAY_TITULO.length; i++) {
			if (GerenciaProfessores.listaDados[5].equalsIgnoreCase(ARRAY_TITULO[i])) {
				indexTitulo = i;
			}
		}
